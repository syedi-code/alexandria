-- Migration: Add threads tables
-- Threads are named, ordered collections of Notes, Thoughts, Quotes, and Books.
-- Uses a dedicated threads + thread_items join table with explicit position ordering.
...
-- =============================================================================
-- Thread Items join table (polymorphic, ordered)
-- =============================================================================
